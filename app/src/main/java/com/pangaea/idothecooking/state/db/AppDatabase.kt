    ...
    companion object {
        ...
        private class PopulateDbAsync(appContext: Context?) :
            ...
            suspend fun initDatabase() {
                ...
                ingredients.add(Ingredient(0, 0, 0, "Potato bread",2.00, "count"))
                ingredients.add(createIngredient(1, 3.00, "count", "American cheese"))
                ingredients.add(createIngredient(2, .50, "tbsp", "Butter"))
                ...
                ingredients2.add(createIngredient(0, 1.00, "count", "Hot dog"))
                ingredients2.add(createIngredient(0, 1.00, "count", "Hot dog bun"))
